...
const unsigned char DesCryptographicKey[]	PROGMEM ={ 0x12,0x34,0x56,0x67,0x89,0xab,0xcd,0xef };
const unsigned char DesPLAINTEXT[]			PROGMEM ={ 0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08 };
const unsigned char DesCIPHERTEXT[]			PROGMEM ={ 0xf2,0xac,0x1b,0xc6,0xbf,0x00,0x61,0xd3 };
...
const unsigned char Triple_DesCryptographicKey[]	PROGMEM ={ 0x12,0x34,0x56,0x67,0x89,0xab,0xcd,0xef,0x22,0x44,0x66,0x88,0xAA,0xBB,0xCC,0xDD };
const unsigned char Triple_DesPLAINTEXT[]			PROGMEM ={ 0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08 };
const unsigned char Triple_DesCIPHERTEXT[]			PROGMEM ={ 0x1A,0x54,0xE3,0x87,0x44,0x34,0x86,0xBC };
