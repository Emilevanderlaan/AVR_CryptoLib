...
const unsigned char test_md5_cmp[] PROGMEM ={0x03,0x83,0xE2,0x85,0x55,0xC6,0xB2,0xD2,0xAE,0x6F,0x8F,0x7A,0x6D,0xF9,0xB3,0x07} ;
...
const unsigned char test_md5_2_cmp[] PROGMEM={0x82,0x15,0xEF,0x07,0x96,0xA2,0x0B,0xCA,0xAA,0xE1,0x16,0xD3,0x87,0x6C,0x66,0x4A };
...
const unsigned char test_md5_3_cmp[] PROGMEM ={0xad,0xeb,0x47,0xec,0x97,0x9f,0x9f,0x74,0xa0,0x6b,0xd1,0xc9,0x28,0x3f,0xb8,0x40};
...
const unsigned char test_md5_4_cmp[] PROGMEM={0x9E,0x10,0x7D,0x9D,0x37,0x2B,0xB6,0x82,0x6B,0xD8,0x1D,0x35,0x42,0xA4,0x19,0xD6};
...
// adeb47ec979f9f74a06bd1c9283fb840 
const unsigned char test_md5_5_cmp[] PROGMEM={0xad,0xeb,0x47,0xec,0x97,0x9f,0x9f,0x74,0xa0,0x6b,0xd1,0xc9,0x28,0x3f,0xb8,0x40};
// abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopqabcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopqmd5TestFectorsJustFortesting:md5TestFectorsJustFortesting:md5TestFectorsJustFortesting
const unsigned char a_md5[] PROGMEM={"abcdbcdecdefdefgefghfg"};
const unsigned char b_md5[] PROGMEM={"highijhijkijkljklmklmnlmnomnopnopq"};
const unsigned char c_md5[] PROGMEM={"md5TestFectorsJustFortesting:md5TestFectorsJustFortesting:md5TestFectorsJustFortesting"};
