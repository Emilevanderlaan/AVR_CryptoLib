...
const unsigned char SkipJack_Test1_Key[10] PROGMEM={0x00,0x99,0x88,0x77,0x66,0x55,0x44,0x33,0x22,0x11};
const unsigned char SkipJack_Test1_Plain[] PROGMEM={0x33,0x22,0x11,0x00,0xdd,0xcc,0xbb,0xaa};
const unsigned char SkipJack_Test1_Cipher[]PROGMEM={0x25,0x87,0xca,0xe2,0x7a,0x12,0xd3,0x00};

const unsigned char SkipJack_Test2_Key[10] PROGMEM={0xe7,0x49,0x6e,0x99,0xe4,0x62,0x8b,0x7f,0x9f,0xfb};
const unsigned char SkipJack_Test2_Plain[] PROGMEM={0x99,0xcc,0xfe,0x2b,0x90,0xfd,0x55,0x0b};
const unsigned char SkipJack_Test2_Cipher[]PROGMEM={0x60,0xa7,0x3d,0x38,0x7b,0x51,0x7f,0xca};
