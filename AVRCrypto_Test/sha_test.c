...
const unsigned char a_sha[] PROGMEM={"abcdbcdecdefdefgefghfg"};
const unsigned char b_sha[] PROGMEM={"highijhijkijkljklmklmnlmnomnopnopq"};
const unsigned char c_sha[] PROGMEM={"SHATestFectorsJustFortesting:SHATestFectorsJustFortesting:SHATestFectorsJustFortesting"};
